			...
			echo "
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-heading'>".'TL'." $pro_price.00
			...
			while ($row=mysqli_fetch_array($query)) {
				...
				echo '
					<div class="row">
						...
						<div class="col-md-3">'.'TL'.''.$product_price.'</div>
					</div>';
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@burakerdogan.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/SE362PHPCODES/ecommerce/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/SE362PHPCODES/ecommerce/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/SE362PHPCODES/ecommerce/cancel.php"/>
